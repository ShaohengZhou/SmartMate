...
export function View_S3ImageComponentCore_Host_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 1, "amplify-s3-image-core", [], null, null, null, View_S3ImageComponentCore_0, RenderType_S3ImageComponentCore)), i0.ɵdid(1, 49152, null, 0, i1.S3ImageComponentCore, [i2.AmplifyService], null, null)], null, null); }
var S3ImageComponentCoreNgFactory = i0.ɵccf("amplify-s3-image-core", i1.S3ImageComponentCore, View_S3ImageComponentCore_Host_0, { data: "data", path: "path" }, { selected: "selected" }, []);
