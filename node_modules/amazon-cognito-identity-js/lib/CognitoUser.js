    ...
    authenticationHelper.getLargeAValue(function (errOnAValue, aValue) {
      ...
      _this2.client.request('InitiateAuth', jsonReq, function (err, data) {
        ...
        authenticationHelper.getPasswordAuthenticationKey(_this2.username, authDetails.getPassword(), serverBValue, salt, function (errOnHkdf, hkdf) {
          ...
          var message = CryptoJS.lib.WordArray.create(_buffer.Buffer.concat([_buffer.Buffer.from(_this2.pool.getUserPoolId().split('_')[1], 'utf8'), _buffer.Buffer.from(_this2.username, 'utf8'), _buffer.Buffer.from(challengeParameters.SECRET_BLOCK, 'base64'), _buffer.Buffer.from(dateNow, 'utf8')]));
    ...
    authenticationHelper.getLargeAValue(function (errAValue, aValue) {
      ...
      _this6.client.request('RespondToAuthChallenge', jsonReq, function (err, data) {
        ...
        authenticationHelper.getPasswordAuthenticationKey(_this6.deviceKey, _this6.randomPassword, serverBValue, salt, function (errHkdf, hkdf) {
          ...
          var message = CryptoJS.lib.WordArray.create(_buffer.Buffer.concat([_buffer.Buffer.from(_this6.deviceGroupKey, 'utf8'), _buffer.Buffer.from(_this6.deviceKey, 'utf8'), _buffer.Buffer.from(challengeParameters.SECRET_BLOCK, 'base64'), _buffer.Buffer.from(dateNow, 'utf8')]));
          var key = CryptoJS.lib.WordArray.create(hkdf);
          var signatureString = CryptoJS.enc.Base64.stringify(CryptoJS.HmacSHA256(message, key));
