...
var Server = /** @class */ (function () {
    ...
    Server.prototype._getKnownCapabilities = function (session) {
        ...
        updates.shortcutKey = (function () {
            var platform = (capabilities.platform || capabilities.platformName);
        ...
        var discoverServerFeatures = function () {
            ...
            if (capabilities.usesWebDriverTimeouts == null) {
                testedCapabilities.usesWebDriverTimeouts = function () {
                    ...
                    return session.setFindTimeout(500).then(unsupported, function (error) {
                        // At least Chrome 60+
            ...
            if (capabilities.usesHandleParameter == null) {
                testedCapabilities.usesHandleParameter = function () {
                    return session
                        ...
                        .then(unsupported, function (error) { return /Missing .*handle/.test(error.message); });
                };
            }
            ...
            if (capabilities.supportsKeysCommand == null) {
                testedCapabilities.supportsKeysCommand = function () {
                    return session
